...
<html lang="en">
  ...
  <body >
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url({{url('assets/static')}}/avatars/000m.jpg)"></span>
    ...
    <!-- Libs JS -->
    <script src="{{url('assets')}}/libs/apexcharts/dist/apexcharts.min.js?1684106062" defer></script>
