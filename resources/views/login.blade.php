...
<html lang="en">
  ...
  <body  class=" d-flex flex-column">
    <script src="{{url('assets')}}/js/demo-theme.min.js?1684106062"></script>
      ...
      <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
          <div class="col-lg">
            <div class="container-tight">
              <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark"><img src="{{url('assets/static')}}/logo.svg" height="36" alt=""></a>
              </div>
                ...
                <div class="card-body">
                  ...
                  <form action="./" method="get" autocomplete="off" novalidate>
                    <div class="mb-3">
                      ...
                      <input type="email" class="form-control" placeholder="Your username" name="username" autocomplete="off">
                    </div>
                    <div class="mb-2">
          ...
          <div class="col-lg d-none d-lg-block">
            <img src="{{url('assets/static')}}/illustrations/undraw_secure_login_pdn4.svg" height="300" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
